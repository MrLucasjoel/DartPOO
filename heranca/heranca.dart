 ...
 * reutilização de código e especialização do comportamento.
 ...
 termo          | explicação
 superclasse    | a classe base que será herdade (também chamada de classe pai)
 ...
 super          | palavra_chave usada para acessas membros da superclasse
 */
...
/**
 ...
 código a nivel de complicação para evitar erros de digitação.
 usar @override deixa claro que você está sobescrevendo um método que existe na
 ...
 * a subclasse pode chamar o contrutor da classe pai usando a palavra super
 */
